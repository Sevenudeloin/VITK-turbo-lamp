...
# ewan.lemonnier, axelle.mandy
def visualize2D():
    # Load mri images and mask from segmentation
    ...
    def create_lookup_table():
        ...
        lut.Build()
        return lut
    # Function to create a lookup table to keep brain details
    def lut_actor():
        lut = vtk.vtkLookupTable()
        lut.SetRange(0, 500)
